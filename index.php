...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Vaccination Management System</a>
  ...
  <header class="bg-primary text-white">
    <div class="container text-center">
      <h1>Group 17 - Vaccination and Covid Testing</h1>
      <p class="lead">Vaccination and Testing Management System</p>
    </div>
  </header>
...
Reported illnesses have ranged from mild symptoms to severe illness and death</p>
  ...
  <footer class="py-5 bg-dark">
    <div class="container">
      <p class="m-0 text-center text-white">Copyright &copy; Group 17 2022</p>
    </div>
    <!-- /.container -->
  </footer>
